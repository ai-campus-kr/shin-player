...
<p align="center"><img src="https://raw.githubusercontent.com/ai-campus-kr/shin-player/v0.6.0-beta.11/docs/screenshots/v0.6.0-beta.11/01-shorts-editor.png" width="980" alt="実際のショート編集画面：縦型プレビュー、ドラッグによる区間選択、韓国語テキストと構図調整"></p>
...
**[この画面から実際に書き出した MP4 を見る](https://github.com/ai-campus-kr/shin-player/releases/download/v0.6.0-beta.11/ShinPlayer-shorts-demo.mp4)** · オリジナルの合成デモ動画を使った実際の画面と出力です。
...
1. [最新リリース](https://github.com/ai-campus-kr/shin-player/releases/tag/v0.6.0-beta.11)から `ShinPlayer-バージョン-win-x64.zip` をダウンロードし、すべて展開します。
...
**「この内容を説明して」→ 字幕に基づいて回答。「その部分へ移動して」→ 再生位置を移動。** [ベータ版をダウンロード](https://github.com/ai-campus-kr/shin-player/releases/tag/v0.6.0-beta.11)
...
[한국AI교육진흥원](https://github.com/ai-campus-kr) · [最新リリース](https://github.com/ai-campus-kr/shin-player/releases/tag/v0.6.0-beta.11) · [不具合報告・機能の提案](https://github.com/ai-campus-kr/shin-player/issues)
